---
title: Using the RCircos Package
abstract: ~
author: |
  Hongen Zhang, Ph.D.\
...
link-citations: yes
bibliography: Using_RCircos-generated.bib
---
...
![graphic without alt text](RCircosLayoutDemo.png){width="100%"}
...
Note: RCircos.Set.Plot.Area() will setup plot area base on total number of tracks inside and outside of chromosome ideogram. User can also setup plot area by summit the R plot commands for user defined plot area, for [[example:\\\\](example:\\){.uri}]([example:\\](example:\){.uri}){.uri}
...
\
![image](RCircosDemoHuman.png){width="100%" alt="graphic without alt text"}
